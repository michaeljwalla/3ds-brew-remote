...
- This person's app inspired me to try and make my own. I used app platforming/simple logging from a classic build of this repo.
- Thanks to this person for inspo and setting up a basic app framework, as I had no idea where/how to start developing a 3ds app.
